...
import com.misenpai.anivault.ui.viewholder.HorizontalAnimeViewHolder

open class BaseAnimeAdapter(
    private val onItemClick: (HorizontalAnime) -> Unit
) : ListAdapter<HorizontalAnime, HorizontalAnimeViewHolder>(HorizontalAnimeDiffCallback()) {
