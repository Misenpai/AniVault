...
class HorizontalAnimeRecommendedAdapter(private val onItemClick: (HorizontalAnime) -> Unit) : ListAdapter<HorizontalAnime, HorizontalAnimeViewHolder>(HorizontalAnimeDiffCallback()) {
    ...
    class HorizontalAnimeDiffCallback : DiffUtil.ItemCallback<HorizontalAnime>() {
        ...
        override fun areContentsTheSame(
            oldItem: HorizontalAnime,
            newItem: HorizontalAnime
        ): Boolean {
